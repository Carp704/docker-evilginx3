...
LABEL org.label-schema.build-date=$BUILD_DATE \
  org.label-schema.name="Evilginx3 Docker" \
  org.label-schema.description="Evilginx3 Docker Build" \
  org.label-schema.url="https://github.com/Carp704/docker-evilginx3" \
  org.label-schema.vcs-ref=$VCS_REF \
  org.label-schema.vcs-url="https://github.com/Carp704/docker-evilginx3" \
  org.label-schema.vendor="Carp704" \
